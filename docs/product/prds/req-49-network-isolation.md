# REQ-49 — Network isolation

## User journey

As a maintainer, I want network isolation controls so that reliability changes fail safely.

## Product requirement

Define a versioned, offline, fail-closed network isolation contract with explicit ownership and evidence.
...
- PROD-49: implement contract data, validation, traceability, and tests.
