...
ROUTER_CONTEXT = (
    ...
    "after the router loads, use Read only for the one directly linked domain "
    "reference needed by the request. Prefer executing bundled scripts as black "
    ...
    "contract instead of inlining generated files. "
