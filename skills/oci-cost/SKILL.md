...
For `cost-scope-report`, consult the local
[`developer-knowledge-catalog.json`](../../docs/product/contracts/developer-knowledge-catalog.json)
before reading the full reference. Validate catalog changes locally; cost
reporting remains read-only by default and retains this skill's scope gates.
