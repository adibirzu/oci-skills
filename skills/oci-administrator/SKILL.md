...
| connect to the database, run SQL, SQLcl, wallet, blocking sessions, lock contention, wait events, slow/top SQL, long-running query, kill session, start/stop/scale Autonomous Database (ATP/ADW) | **oci-autonomous-db** | [references/autonomous-db.md](../../references/autonomous-db.md) |
