...
description: >-
  ...
  Mermaid, narrative visual summaries, at-a-glance project capability pages, or
  project lifecycle requests. Routes to
...
| at-a-glance visual summary, visual briefing, executive map, narrative sketchnote, project capability image, comic-style story map | **oci-visual-summary** | [skills/oci-visual-summary/SKILL.md](../oci-visual-summary/SKILL.md) |
...
**oci-visual-summary** owns grounded narrative at-a-glance maps and project
capability images; it does not replace editable technical topology or claim
live project state.
