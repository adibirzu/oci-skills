...
For `project-lifecycle`, consult the local
[`developer-knowledge-catalog.json`](../../docs/product/contracts/developer-knowledge-catalog.json)
before loading deeper material. Run local `validate` after catalog changes. Project work retains phase selection and all underlying owner gates.
